...
?>
		...
		<div class="col-md-9">
			...
			<div class="row">
					<div class="search">
						<form action="file/doSearchFile.php" method="GET" role="search">
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-bordered table-list">
                  ...
                  <tbody>
<?php
	$result = $connect->query("SELECT * FROM files WHERE id_user='".$id_user."' AND id_file");
	if($result->num_rows > 0)
	{
		while($row = $result->fetch_assoc())
		{
?>
                          <tr>
                            <td align="center">
                              ...
                              <a href="file/editfile.php?id_file=<?php echo $row['id_file']; ?>" class="btn btn-default"><em class="fa fa-pencil"></em></a>
