...
?>
		...
		<div class="col-md-9">
            <div class="profile-content">
				<div class="row">
					<div class="search">
						<form action="user/doSearchUsers.php" method="GET" role="search">
            ...
            <div class="panel panel-default panel-table">
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col col-xs-6 text-right">
                    <a href="user/createusers.php" type="button" class="btn btn-sm btn-primary btn-create">Create New</a>
                  </div>
                </div>
              </div>
              <div class="panel-body">
                <table class="table table-striped table-bordered table-list">
                  ...
                  <tbody>
				  <?php
	$result = $connect->query("SELECT `id_user`,`full_name`, `display_name`, `email`, `password`, `gender`, `avatar_url`, `create_at`, `update_at`, `flags_active` FROM `users`");
	if($result->num_rows > 0)
	{
...
?>
                          <tr>
                            <td align="center">
                              <a href="user/editusers.php?id_user=<?php echo $row["id_user"]; ?>" class="btn btn-default"><em class="fa fa-pencil"></em></a>
							  <a href="javascript:confirmDelete('user/doDeleteUsers.php?id_user=<?php echo $row["id_user"]; ?>')" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                            </td>
