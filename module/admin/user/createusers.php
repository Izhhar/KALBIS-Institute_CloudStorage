...
?>
		...
		<div class="col-md-9">
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
				<form role="form" id="create_user" method="POST" action="doCreateUsers.php">
						<div class="row">
						...
						<div class="form-group">
							<div class="input-group">
								<select name="flags_active" class="form-control input-lg">
								  <option value="">Flags Active</option>
						...
						<div class="row">
							<div class="col-xs-12 col-md-6"><input type="submit" value="Create" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
							<div class="col-xs-12 col-md-6"><a href="../users.php" class="btn btn-danger btnBack btn-lg">Cancel</a></div>
						</div>
				</form>
				<div class="row">
