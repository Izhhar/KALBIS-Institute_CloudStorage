...
?>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
				<?php
			$result = $connect->query("SELECT `id_user` FROM `users` WHERE `id_user`='".$_GET['id_user']."'");
	if($result->num_rows > 0)
	{
		while($row = $result->fetch_array())
		{?>
						<div class="row">
							<form id="FormChangePassword" action="doResetPassword.php?id_user=<?php echo $row["id_user"]; ?>" method="post">
								<div class=" col-md-12 col-lg-12"> 
									...
									<a href="../users.php" type="button" class="btn btn-danger">Cancel</a>
